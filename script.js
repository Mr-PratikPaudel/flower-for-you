...
var tl = gsap.timeline()
  ...
  .fromTo('#BaseGroup16_1_ path', { autoAlpha: 1, scale: 0, transformOrigin: '-10% 130%' }, { duration: 1, scale: 1 }, 'flower1')
  .fromTo('#PinkFlowerGroup16_1_', { autoAlpha: 1, scale: 0, transformOrigin: '35% 110%' }, { duration: 2, scale: 1 }, 'flower1-=0.55')
  .fromTo('#BaseGroup1_1_ path', { autoAlpha: 1, scale: 0, transformOrigin: '90% 130%' }, { duration: 1, scale: 1 }, 'flower1')
  ...
  // Dots
  .fromTo(dots, { autoAlpha: 0 }, { duration: 6, autoAlpha: 1, ease: "expo.out" }, 'flower3+=1')
  ...
  .fromTo("#flowerText", 
    ...
    {duration: 2, opacity: 1, scale: 1, ease: "power2.out"}, 
    "flower3+=1.5"
  );
